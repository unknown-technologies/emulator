...
typedef struct {
	...
	u8 (* read)(void *context, u16 address);
	...
	void (* write)(void *context, u16 address, u8 value);
	...
	void (* out)(void *context, u16 port, u8 value);
	...
	void (* halt)(void *context, BOOL state);
...
void z80_int(Z80 *object, BOOL state);
